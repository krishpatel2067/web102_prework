...
function addGamesToPage(games) {
    ...
    for (const g of games) {
        ...
        div.innerHTML = `
            ...
            <p><b>${g.name}</b></p>
            <p>Pledged: $${g.pledged.toLocaleString('en-US')}</p>
        `;
...
const totalCont = GAMES_JSON.reduce((acc, game) => acc + game.backers, 0);
...
const str = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalGames == 1 ? "1 game" : `${totalGames} games`}. Currently, ${numUnfunded == 1 ? "1 game remains" : `${numUnfunded} games remain`} unfunded. We need your help to fund these amazing games!`;
